...
\begin{figure}[htb!]
    \begin{subfigure}{.6\textwidth}
        \centering
        \includegraphics[height=.15\textheight]{./img/原理2.2.3a.png}
        \caption{宽边纵缝及其等效电路}
        \label{fig_principle_2.2.3a}
    \end{subfigure}\\
    \begin{subfigure}{.6\textwidth}
        \centering
        \includegraphics[height=.15\textheight]{./img/原理2.2.3b.png}
        \caption{窄边横缝及其等效电路}
        \label{fig_principle_2.2.3b}
    \end{subfigure}\\
    \begin{subfigure}{.6\textwidth}
        \centering
        \includegraphics[height=.15\textheight]{./img/原理2.2.3c.png}
        \caption{宽边中心斜缝及其等效电路}
        \label{fig_principle_2.2.3c}
    \end{subfigure}\\
    \begin{subfigure}{.6\textwidth}
        \centering
        \includegraphics[height=.15\textheight]{./img/原理2.2.3d.png}
        \caption{宽边斜缝及其等效电路}
        \label{fig_principle_2.2.3d}
    \end{subfigure}\\
    \begin{subfigure}{.6\textwidth}
        \centering
        \includegraphics[height=.15\textheight]{./img/原理2.2.3e.png}
        \caption{窄边斜缝及其等效电路}
