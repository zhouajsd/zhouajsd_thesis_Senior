...
LaTeX（通常发音为 "Lay-tech" 或 "Lah-tech"）是一种高质量排版系统，它特别适用于技术和科学文档的制作。LaTeX 基于 TeX 排版系统，由 Donald Knuth 开发，而 LaTeX 本身则是由 Leslie Lamport 在21世纪80年代创建的。LaTeX 的主要特点包括：
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=.6\textwidth]{./img/fonts.png}
    \caption{字体放置目录示意}
    \label{fig_fonts}
\end{figure}
...
\begin{figure}[htb!]
    ...
    \begin{subfigure}{.4\textwidth}
        \centering
        \includegraphics[width=.10\textwidth]{./img/texstudio1.jpeg}
        \caption{错误提示}
        \label{fig_texstudio_2}
    \end{subfigure}
    \begin{subfigure}{.4\textwidth}
        \centering
        \includegraphics[width=.10\textwidth]{./img/texstudio2.jpeg}
        \caption{代码补全}
        \label{fig_texstudio_3}
    \end{subfigure}
    \begin{subfigure}{.4\textwidth}
        \centering
        \includegraphics[width=.10\textwidth]{./img/texstudio3.jpeg}
        \caption{代码检查}
        \label{fig_texstudio_4}
    \end{subfigure}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=.10\textwidth]{./img/vscode.jpeg}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=.10\textwidth]{img/eg1.png}
    \caption{示例图片2}
    \label{fig_eg2}
\end{figure}
\end{lstlisting}
...
\begin{figure}[htb!]
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[height=.16\textheight]{./img/cat1.jpeg}
        \caption{小猫2}
        \label{fig_cat_2}
    \end{subfigure}
    \begin{subfigure}{.26\textwidth}
        \centering
        \includegraphics[height=.16\textheight]{./img/cat2.jpeg}
        \caption{小猫3}
        \label{fig_cat_3}
    \end{subfigure}
    \begin{subfigure}{.26\textwidth}
        \centering
        \includegraphics[height=.16\textheight]{./img/cat3.jpeg}
        \caption{小猫4}
        \label{fig_cat_4}
    \end{subfigure}
    \caption{示例图片3}
...
从中我们可以看到，\texttt{\textbackslash begin\{subfigure\}} 和 \texttt{\textbackslash end\{subfigure\}} 命令用于创建子图，\texttt{\textbackslash caption} 命令用于设置子图标题，\texttt{\textbackslash label} 命令用于设置子图标签，\texttt{.5\textbackslash textwidth} 表示子图的宽度为当前页面宽度的 0.4 倍，\texttt{.15\textbackslash textwidth} 表示子图的高度为当前页面高度的 0.15 倍。
...
\begin{lstlisting}[language=TeX]
\begin{equation}\label{eq_eg3}
    \int_{-\infty}^{+\infty} e^{-x^3} dx = \sqrt{\pi}.
\end{equation}
\cref{eq_eg3} 是一个示例公式。
\end{lstlisting}

\begin{equation}\label{eq_eg3}
    \int \frac{2}{x^2} dx = -\frac{1}{x}.
\end{equation}
\cref{eq_eg3} 是一个示例公式。
...
\begin{lstlisting}[language=TeX]
这是\cref{fig_eg2}，这是\cref{tab_eg}，这是\cref{alg_eg}。
\end{lstlisting}
...
\begin{lstlisting}[language=TeX]
这些是\cref{fig_cat_2,fig_cat_2,fig_cat_3}，那些是\cref{fig_eg1,tab_eg,alg_eg}。
\end{lstlisting}
